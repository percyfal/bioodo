...
# -*- coding: utf-8 -*-
#
# bioodo documentation build configuration file, created by
...
from bioodo import __version__
...
latex_documents = [
    (master_doc, 'bioodo.tex', 'bioodo Documentation',
     'Per Unneberg', 'manual'),
]
...
man_pages = [
    (master_doc, 'bioodo', 'bioodo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'bioodo', 'bioodo Documentation',
     author, 'bioodo', 'One line description of project.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    #'odo': ('http://bokeh.pydata.org/en/latest/docs/', None),
}
